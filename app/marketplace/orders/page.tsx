...
export default function OrdersPage() {
  ...
  // Filter orders - now we check both user ID and wallet address
  const userOrders = orders.filter((order) => {
    // If we have a user ID, check if the order address matches the user ID
    if (user && order.address.toLowerCase() === user.id.toLowerCase()) {
      return true
    }

    // If we have a wallet address, check if the order address matches the wallet address
    if (account && order.address.toLowerCase() === account.toLowerCase()) {
      return true
    }
