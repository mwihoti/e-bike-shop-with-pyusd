...
import { Loader2, AlertCircle, CheckCircle, ArrowLeft, Code, FileJson, List } from "lucide-react"
            ...
            <CardHeader>
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
                <div>
                  ...
                  <CardDescription className="font-mono break-all">{receipt.hash}</CardDescription>
                </div>
                <Badge
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div>
                    {receipt.effectiveGasPrice ? (Number(receipt.effectiveGasPrice) / 1e9).toFixed(2) + " Gwei" : "N/A"}
                  </div>
                </div>
                <div>
          ...
          {receipt.pyusdTransfers && receipt.pyusdTransfers.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  This transaction contains {receipt.pyusdTransfers.length} PYUSD transfer
                  {receipt.pyusdTransfers.length > 1 ? "s" : ""}
                </CardDescription>
              </CardHeader>
              <CardContent>
